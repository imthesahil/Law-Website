...
import { Menu, X, ArrowLeft, Mail, MessageSquare } from "lucide-react"
import { Button } from "@/components/ui/button"
import { useState } from "react"
import Link from "next/link"
import Image from "next/image"

export default function UnsaidContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fefae0]">
          ...
          <div className="flex items-center justify-between h-12">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <Link href="/unsaid/contact" className="text-[#d4a373] font-medium border-b-2 border-[#d4a373] pb-1 text-sm">
                  Contact Us
                </Link>
              </div>
            </div>
      ...
      {/* Content */}
      <div className="pt-32 sm:pt-36 pb-16 min-h-screen flex items-center justify-center">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-[#d4a373]/20 px-4 py-2 rounded-full border border-[#d4a373]/30 mb-4">
              <MessageSquare className="w-5 h-5 text-[#d4a373]" />
              <span className="text-sm text-[#d4a373] font-medium">Get in Touch</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-light mb-4 text-[#d4a373]">Contact Us</h1>
            <p className="text-[#2d3748] text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
              Have questions about UNSAID? We're here to help.
            </p>
          </motion.div>
